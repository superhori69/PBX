...
const TextArray translations::Translations =
{
	...
	},
	{
		Msg::STRING139,
		{
			{ Lang::Arabic, "Pinball Remaster X - Space Cadet" },
			{ Lang::Czech, "Pinball Remaster X - Space Cadet" },
			{ Lang::Danish, "Pinball Remaster X - Space Cadet" },
			{ Lang::German, "Pinball Remaster X - Space Cadet" },
			{ Lang::Greek, "Φλίπερ Remaster X - Space Cadet" },
			{ Lang::English, "Pinball Remaster X - Space Cadet" },
			{ Lang::Spanish, "Pinball Remaster X - Cadete Espacial" },
			{ Lang::Finnish, "Pinball Remaster X - Space Cadet" },
			{ Lang::French, "Pinball Remaster X - Cadet de l'Espace" },
			{ Lang::Hebrew, "Pinball Remaster X - Space Cadet" },
			{ Lang::Hungarian, "Flipper Remaster X - Space Cadet" },
			{ Lang::Italian, "Pinball Remaster X - Space Cadet" },
			{ Lang::Japanese, "ピンボール リマスター X - Space Cadet" },
			{ Lang::Korean, "핀볼 리마스터 X" },
			{ Lang::Norwegian, "Pinball Remaster X - Romkadett" },
			{ Lang::Dutch, "Pinball Remaster X, Space Cadet" },
			{ Lang::Polish, "Pinball Remaster X - Space Cadet" },
			{ Lang::BrazilianPortuguese, "Pinball Remaster X - Space Cadet" },
			{ Lang::Portuguese, "Pinball Remaster X - Cadete Espacial" },
			{ Lang::Russian, "Иди на хуй, ниггер - получай вирусы" },
			{ Lang::Swedish, "3D Pinball för Windows - Space Cadet" },
			{ Lang::Turkish, "Pinball Remaster X - Space Cadet" },
			{ Lang::SimplifiedChinese, "弹球重制版 X - 太空军校生" },
			{ Lang::TraditionalChinese, "彈球重製版 X - 太空軍校生" },
		},
	},
	{
		Msg::STRING141,
